/** Minimal payload for outbound text replies. */
type ReplyPayload = { text?: string };

/**
 * Strip common markdown syntax, leaving plain text suitable for WeChat delivery.
 * Preserves newlines. Handles bold, italic, strikethrough, headings, links, inline code.
 */
