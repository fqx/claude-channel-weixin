---
name: configure
description: Set up the WeChat channel — initiate QR login and review access policy. Use when the user asks to configure WeChat, asks "how do I connect WeChat", wants to log in again, or wants to check channel status.
---
...
Claude Code session (`claude --channels plugin:weixin@fqx`).
